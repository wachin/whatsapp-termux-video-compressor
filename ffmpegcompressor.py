...
TEXT = {
    "en": {
        ...
        "help_lines": [
            ...
            "  Left/Right: decrease/increase numeric values. On Scale, they switch between landscape and portrait.",
            ...
            "",
            "Available presets",
            "  Video bitrate: 550, 500, 450, 400, 350, 300, 250, 200, 180, 170, 160, 150, 145, 140, 130 kbit/s.",
            "  Audio bitrate: 320, 192, 160, 144, 128, 112, 96, 80, 64, 56, 48, 40 kbit/s.",
            "  Framerate: 15, 24, 30 fps.",
            "  Audio channels: 1 mono, 2 stereo.",
            "  Sample rate: 96000, 48000, 44100, 32000, 24000, 22050, 16000 Hz.",
            "  Video examples: mp4, mkv, avi, mov, flv, wmv, webm, m4v, 3gp, mpeg, mpg, ts, mts, m2ts.",
            "",
            "Old WhatsApp examples",
            "  220k video, 512x288, 15 fps, mono audio, 30k audio, 44100 Hz: a 7:58 video became 15.5 MB.",
            "  The same settings also converted an 8:22 video to 15.2 MB.",
            "  200k video, 512x288, 15 fps, mono audio, 30k audio: examples around 8-9 minutes ended near 12-15.5 MB.",
            "",
            "Why these defaults",
    ...
    "es": {
        ...
        "help_lines": [
            ...
            "  Izquierda/Derecha: bajar/subir valores numericos. En Escala, cambian entre horizontal y vertical.",
            ...
            "",
            "Valores disponibles",
            "  Bitrate video: 550, 500, 450, 400, 350, 300, 250, 200, 180, 170, 160, 150, 145, 140, 130 kbit/s.",
            "  Bitrate audio: 320, 192, 160, 144, 128, 112, 96, 80, 64, 56, 48, 40 kbit/s.",
            "  Fotogramas/s: 15, 24, 30 fps.",
            "  Canales audio: 1 mono, 2 estereo.",
            "  Frecuencia audio: 96000, 48000, 44100, 32000, 24000, 22050, 16000 Hz.",
            "  Videos de ejemplo: mp4, mkv, avi, mov, flv, wmv, webm, m4v, 3gp, mpeg, mpg, ts, mts, m2ts.",
            "",
            "Ejemplos antiguos para WhatsApp",
            "  220k video, 512x288, 15 fps, audio mono, audio 30k, 44100 Hz: un video de 7:58 quedo en 15.5 MB.",
            "  Con esos mismos valores, un video de 8:22 quedo en 15.2 MB.",
            "  Con 200k video, 512x288, 15 fps, audio mono y audio 30k, videos de 8-9 minutos quedaron cerca de 12-15.5 MB.",
            "",
